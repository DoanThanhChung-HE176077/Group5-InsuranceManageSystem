                            ...
                            <div class="row">
                                <div class="col-md-5 border-right">
                                    ...
                                    <c:if test="${sessionScope.user.getUser_iden_img() == null}">
                                        <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                            <img id="idenImage" class="img-thumbnail myimg" width="350px" src=""
                                                data-toggle="modal" data-target="#myModal" hidden="">
                                        </div>
                                        <!-- Modal -->
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row ">
                                            <div class="col-md-12"> <input type="text" id="user_id2"
                                                    class="form-control" placeholder="UserID" hidden></div>
                                            ...
                                            <div class="col-md-12"><label class="labels">Địa chỉ: </label><input
                                                    type="text" class="form-control" id="user_address2"
                                            ...
                                            <div class="col-md-12"><label class="labels">Trạng thái tài khoản</label>
                                                <input type="text" class="form-control" id="user_status" value=""
                                                    readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-5 border-right">
                                        <div class="p-3 py-5">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-md-12"><label class="labels">Số điện
                                                        thoại:</label><input type="number" class="form-control"
                                                        id="user_phoneNum2" placeholder="Phone Number" readonly></div>
                                                <div class="col-md-12"><label class="labels">Số CMTND/CCCD</label>
                                                    <input type="number" class="form-control" id="user_iden2"
                                                        placeholder="Identification" readonly></div>
                                                <div class="col-md-12"><label class="labels">Trạng thái tài
                                                        khoản</label>
                                                    <input type="text" class="form-control" id="user_status" value=""
                                                        readonly>
                                                </div>
