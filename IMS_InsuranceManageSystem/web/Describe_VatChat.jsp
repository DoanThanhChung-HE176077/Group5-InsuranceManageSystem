<%-- 
    Document   : Describe_VatChat
    Created on : Nov 10, 2023, 11:02:42 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <div id="a" class=" container product-describe">
            ...
            <ul style="padding-left: 17px; ">
                ...
                <li>
                    ...
                    hệ thống điện, hệ thống làm mát, vv. bị hỏng. </li>
                <li>
        ...
        <div id="b" style="display: none; margin-bottom: 50px;"
            class=" container block-post">
