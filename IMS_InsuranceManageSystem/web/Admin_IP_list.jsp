                    ...
                    <table>
                            ...
                            <c:forEach items="${listIP}" var="o">
                                <tr>
                                    ...
                                    <td>${o.getIp_name()}</td>
                                    <td>
                                        <a href="admin_IP_detail?id=${o.getIp_id()}" class="my-btn btn btn-primary" data-bs-toggle="modal" data-bs-target="#my-modal-detail"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="recipient-name" name="id" value="${admin_IP_detail.getIp_id()}">
                            </div>
                            <div class="mb-3">
                                <label for="message-text" class="col-form-label">Type:</label>
                                <textarea class="form-control" id="message-text" name="type" required="${admin_IP_detail.getIp_type()}"></textarea>
                            </div>
                        <div class="mb-3">
                                <label for="message-text" class="col-form-label">Name:</label>
                                <textarea class="form-control" id="message-text" name="name" required="${admin_IP_detail.getIp_name()}"></textarea>
                            </div>
