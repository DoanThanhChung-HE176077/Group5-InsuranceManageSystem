                                ...
                                <div class="my-column1 col-md-8">
                                    ...
                                    <form action="Admin_Contract_search" method="post" class="form-inline my-2 my-lg-0">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <input value ="${txtname}" name="txtname" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Tìm kiếm hợp đồng theo người dùng">
