<%-- 
    Document   : Describe_TNDS
    Created on : Nov 10, 2023, 4:41:21 PM
    Author     : Dell
--%>
       ...
       <div class="header-main container">
            ...
            <div  id="a" class=" container product-describe">
                <p>
                    ...
                    Đồng thời tham gia bảo hiểm là bạn đã chấp hành đúng chủ trương chính sách pháp luật của Nhà nước và luật giao thông đường bộ.
                </p>
            ...
            <div id="b" style="display: none;" class=" container block-post">
                ...
                <ul>
                    <li>- Mức trách nhiệm bảo hiểm đối với thiệt hại về người do xe cơ giới gây ra là 150 triệu đồng/1 người/1 vụ tai nạn.</li>
                    <li>
                    ...
                    <li>- Mức trách nhiệm bảo hiểm đối với thiệt hại về tài sản do xe ô tô, máy kéo, xe máy thi công, xe máy nông nghiệp, lâm nghiệp và các loại xe đặc chủng khác sử dụng vào mục đích an ninh, quốc phòng (kể cả rơ-moóc và sơ mi rơ-moóc được kéo bởi xe ô tô hoặc máy kéo) gây ra là 100 triệu đồng/1 vụ tai nạn.</li>
                </ul>
