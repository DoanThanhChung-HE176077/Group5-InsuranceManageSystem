                        ...
                        <div class="col-md-6 " >
                            <div class="p-3 py-5">
                                <div class="login-default" style="align-items: center;">
                                    <form action="Admin_Staff_update" method="post">
                                        ...
                                        <div style="display: none;">
                                            ...
                                            <div class="input-group" style="margin-right: 10px;">
                                                <input value="${detail.getUser_id()}" name="id" type="text" id="" class="form-control" placeholder="Nhập số điện thoại" required invalid-message="Vui lòng nhập">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <input value="${detail.getUser_dob()}" name="input-dob" type="text" id="datepicker" class="form-control" placeholder="Nhập ngày sinh" style="background-color: #fff !important;" required>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <input value="${detail.getUser_address()}" name="input-address" type="text" id="" class="form-control" placeholder="Nhập địa chỉ" required>
                                    </div>
