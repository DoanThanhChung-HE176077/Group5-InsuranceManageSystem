...
//    @Override
//    public String toString() {
//        return "Blogs{" + "bl_id=" + bl_id + ", bl_title=" + bl_title + ", bl_content=" + bl_content + ", bl_like=" + bl_like + ", bl_img=" + bl_img + ", bl_author=" + bl_author + ", bl_creationdate=" + bl_creationdate + ", bl_tag_id=" + bl_tag_id + ", bl_view=" + bl_view + ", bl_status=" + bl_status + '}';
//    }
//
//
//
